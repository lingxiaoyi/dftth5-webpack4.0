...
(function() {
  let {refreshUrl,pullDownUrl,pullUpUrl,sportsListUrl,sportsMatchUrl,videoUrl,picUrl,autoUrl,positionUrl,voteUpUrl,voteDownUrl,duanziUrl,logUrl,onlineUrl,showAdLogUrl,clickAdLogUrl,dspUrl,unionUrl} = config.API_URL.INDEX
  /* 年货节活动 下拉广告 配置 */
  ...
  var nhjActQids = {
    ...
    phonepingtai: [],
    huisuoping01: [],
    qid02636: ['北京', '上海', '广东', '福建'],
    mrzd: ['北京', '上海', '广东', '江苏'],
    qid10364: ['北京', '上海', '广东', '浙江'],
    qid10776: ['广东'],
    qid10373: ['北京', '上海', '广东'],
    qid10759: ['上海'],
    qid10832: ['北京', '上海', '广东'],
    qid10833: ['北京', '上海', '广东'],
    qid10819: ['北京', '上海', '广东', '安徽'],
    qid10811: ['北京', '上海', '广东'],
    qid10370: ['北京', '上海', '广东', '浙江'],
    qid10946: ['北京', '上海', '广东'],
    qid10372: ['北京', '上海', '广东', '陕西'],
    qid10367: ['北京', '上海', '广东'],
    qid10751: ['广东'],
    qid10834: ['北京', '上海', '广东'],
    qid10827: ['北京', '上海', '广东'],
    qid10498: ['北京', '上海', '广东', '福建']
  };
  var nhjActTime = {
    start: Date.parse('2019/01/9 23:55'),
    second: Date.parse('2019/01/12 23:55'), // 第二轮开始时间 根据这个区分不同的素材和统计id
    end: Date.parse('2019/01/17 23:55')
  };
  var nhjActOptions = {
    isLoad: nhjActQids[GLOBAL.Et.qid],
    advId: 'newyear_pulldown1_h5',
    advUrl:
      'https://s.click.taobao.com/t?e=m%3D2%26s%3Dvt5cNa1K0BAcQipKwQzePCperVdZeJviEViQ0P1Vf2kguMN8XjClArpqXFbWhQvy5ZgrgZz4iQLXO%2BqAgJq5vEHuC78NBA8efMtz9DlDAeqO7KoPkn0%2FFj3s9MhxE0q6AgLbN2peQYN8isIqg9litAZn%2By0keumoL1zhcxbolbm1jhC3ZxnWVeoPXyFbMSxd',
    imgUrl: '//mini.eastday.com/toutiaoh5/img/nhj/pulldown1.png',
    cookieName: 'nhj_pulldown1'
  };
  if (currentMs > nhjActTime.second) {
    nhjActOptions = {
      isLoad: nhjActQids[GLOBAL.Et.qid],
      advId: 'newyear_pulldown2_h5',
      advUrl:
        'https://s.click.taobao.com/t?e=m%3D2%26s%3DhlmHn00yTuEcQipKwQzePCperVdZeJviEViQ0P1Vf2kguMN8XjClAjPZEp7zLU4BBm5A8hOqJNbXO%2BqAgJq5vEHuC78NBA8eijXoCA9DapkJ7czqYpRjTk%2Fu2BptvxUXAgLbN2peQYN8isIqg9litAZn%2By0keumoL1zhcxbolbm1jhC3ZxnWVeoPXyFbMSxd',
      imgUrl: '//mini.eastday.com/toutiaoh5/img/nhj/pulldown2.png',
      cookieName: 'nhj_pulldown2'
    };
  }
  ...
  var hasDuanziQids = ['null', 'ioswechat', 'baiducom', 'qid00904', 'qid00901', 'qid00099'];
  var newNewsQids = ['vivobrowser', 'ccllq', 'jinlisun', 'xtzm', '2345yuki', 'qid10000', 'ucllqsun']; // 18-05-09 新闻接口改版 部分渠道启用
  var testQids = {
  ...
  function EastNews() {
    ...
    var currentNewsType = ct || wsCache.get('current_newstype_' + GLOBAL.Et.qid);
    this.newsType = currentNewsType || (GLOBAL.Et.qid === 'qid10768' ? 'shipin' : 'toutiao'); // 新闻频道类别
    ...
    this.idx = 0; // 链接索引
    this.pgNum = 1; // 页码
    this.pulldown_pgNum = Number(wsCache.get('pulldown_pgnum_' + this.newsType + '_' + GLOBAL.Et.qid)) || -1; // 下拉页码
  ...
  EastNews.prototype = {
    ...
    init: function() {
      ...
      /* 注册下拉事件 */
      // scope.pullDown();
      if (nhjActOptions.isLoad && currentMs > nhjActTime.start && currentMs < nhjActTime.end) {
        var isHave = true;
        if (scope.filterArea(nhjActOptions.isLoad) || Cookies.get(nhjActOptions.cookieName)) {
          isHave = false;
        }
        scope.initPulldown(isHave);
      } else {
        scope.initPulldown(false);
      }
      ...
      $(window).on('scroll', function() {
        ...
        timer = setTimeout(function() {
          wsCache.set('news_pos_' + scope.newsType + '_' + GLOBAL.Et.qid, scrollTop, {
            exp: 40 * 60
          });
        }, 200);
      ...
      $newsList.on('click', '.news-item > a', function(e) {
        ...
        // var urlNum = '';
        var urlNum = url.substring(url.lastIndexOf('/') + 1, url.indexOf('.html'));
      ...
      try {
        ...
        $body.on('click', '.J-uni-news', function() {
          var $this = $(this);
    ...
    popNews: function() {
      var scope = this;
      if (Number(Cookies.get('h5_gback_list')) !== 1) {
        return;
      }
      $.ajax({
        url: 'https://mini.eastday.com/tyhhapi/tyhh_toutiao.json',
        dataType: 'json',
        success: function(res) {
          var data = res ? res.data : '';
          data = data.slice(0, 2);
          scope.generatePopDom(data);
          Cookies.set('h5_gback_list', 0, {
            expires: 1,
            path: '/',
            domain: 'eastday.com'
          });
    ...
    generatePopDom: function(d) {
      var scope = this;
      var advId = 'qid10970_topic_h5';
      var $popWrap = $('<div class="pop-wrap"></div>');
      var $popList = $(
        '<div class="pop-content news-list-wrap"><h3 class="title">热点新闻</h3><p class="desc">---- 东方头条给您推荐以下内容 ----</p></div>'
      );
      for (var i = 0; i < d.length; i++) {
        var item = d[i];
        var url = item.url + '?qid=' + GLOBAL.Et.qid;
        var dateStr = scope.getSpecialTime(item.date);
        var topic = item.topic;
        var source = item.source;
        var imgArr = item.miniimg;
        var aStr = '<a href="' + url + '" class="J-promote-news" data-advid="' + advId + '">';
        ...
        if (imgLen >= 3) {
          $popList.append(
            ...
            '</h3>' +
            '<div class="img-wrap">' +
            '<div class="img"><img class="lazy" src="' +
          ...
          $popList.append(
            ...
            '</p>' +
            '</div>' +
            '<div class="img-wrap"><img class="lazy" src="' +
            (imgArr.length ? scope.replaceImg(imgArr[0].src) : '') +
            '"></div>' +
            '</div>' +
            '</a>' +
        ...
        if (i === 0) {
          ...
          script.src = '//sh996.dftoutiao.com/site/openjs/js/5469.js?qldkrktm=m';
          $popList.append(script);
        }
      }
      $('body').append($popWrap.append($popList.append('<a href="javascript:;" class="close">关闭</a>')));
      scope.cancleSlide();
      scope.sendAdShowLog({
        advId: advId
      });
      $('.pop-wrap .close').click(function(e) {
        e.preventDefault();
        scope.addSlide();
        $(this)
        .parent()
      ...
      $newsDomArr.each(function() {
        ...
        if (tH - sH + lh < wH) {
          if (hasView !== 1) {
            ...
            wsCache.set('read_urlnum_' + scope.newsType + '_' + GLOBAL.Et.qid, JSON.stringify(scope.readUrlNum)); // 记录已经看到的新闻
    ...
    sendInviewLog: function($target) {
      ...
      var data = {
        ...
        qid: GLOBAL.Et.qid,
        uid: GLOBAL.Et.uid,
        loginid: GLOBAL.Util.getQueryString('ttaccid') || GLOBAL.Util.getQueryString('ac') || 'null',
    ...
    isVisible: function($ggDom) {
      ...
      if (screenHeight + scrollTop - ggOffsetTop > ggHeight / 2 && scrollTop - ggOffsetTop < ggHeight / 2) {
        return true;
      }
      return false;
    },
    ...
    updateVisibleGg: function() {
      ...
      ggItemArr.forEach(function(ggItem) {
        ...
        if (GLOBAL.Et.ggForUpdate[ggIndex] && GLOBAL.Et.ggForUpdate[ggIndex][index]) {
          $(ggItem)
          .html('')
    ...
    insertChannels: function($newsTabs) {
      ...
      if (GLOBAL.Et.qid === 'qid10768') {
        $newsTabs.eq(0).before('<a data-type="shipin">视频</a>');
      } else if (!deleteVideoChannel[GLOBAL.Et.qid]) {
    ...
    loadTxtGg: function(i, $ggWrap, isAppend) {
      ...
      if (ggId) {
        var $txtGgWrap = $('<div class="txt-gg" style="padding: 0.12rem 0; border-bottom: 7px solid #f4f4f4;"></div>');
        if (isAppend) {
        ...
        GLOBAL.Util.getScript('//sh996.dftoutiao.com/' + ggId + '.js', function() {}, $('#' + ggId)[0]);
      }
    },
    ...
    filterUrl: function(options) {
      ...
      try {
        if (qids.contains(GLOBAL.Et.qid)) {
          ...
          // 将图片拼接成字符串
          if (imgLen > 1) {
            imgSrc += encodeURIComponent(imgSrcArr[0] + '@@' + imgSrcArr[1] + '@@' + imgSrcArr[2]);
          } else {
    ...
    initChannels: function(callback) {
      var scope = this,
        myChannels = wsCache.get('CUSTOM_CHANNELS_170906') ? wsCache.get('news_channels') : null;
      if (!myChannels) {
    ...
    generateChannelTabs: function(myChannels) {
      ...
      try {
        if (!isThanAndroid4) {
          myChannels = myChannels.filter(function(x) {
            return x.name !== 'shipin';
          });
        }
        myChannels = myChannels.filter(function(x) {
          return !['xiaohua', 'meinv'].contains(x.name);
        });
      } catch (e) {
        console.error(e);
      }
    ...
    initPulldown: function(isHave) {
      var scope = this;
      scope.pullDownAnimate(isHave, function() {
        // 美女无pulldown接口
        if (scope.newsType !== 'meinv') {
          scope.changeRefreshStatus();
          scope.pullDownLoadData(function() {});
    ...
    pullDownAnimate: function(isHave, callback) {
      GLOBAL.Util.createStyle(
        '#pullDowns{display:inline-block;width:.2rem;height:.2rem;border-radius:.2rem;border:1px solid #666;z-index:1;margin-top:.25rem}#pullDown{height:1rem;position:absolute;top:.73rem;left:0;width:100%;text-align:center;z-index:-99;display:none}'
      );
      var scope = this;
      var showLogFlag = true;
      var advUrl = nhjActOptions.advUrl;
      var dom = $('#J_content');
      var advId = nhjActOptions.advId;
      var imgDom =
        isHave === true
          ? '<img class="pull-down-img" style="width:100%;position:absolute;left:0;top:0;" src=" ' +
          nhjActOptions.imgUrl +
          ' " >'
          : '';
      var pullGifDom = $(
        '<div id="pullDown" style="display: none; transform-origin: 0px 0px 0px; opacity: 1; transform: scale(1, 1);"><span class="pull-down-span">' +
        imgDom +
        ' </span><span id="pullDowns" class="loadingGif" style="opacity: 1; transform: scale(1.41, 1.41); transition: all 0.5s ease 0s;"></span><p style="font-size: 12px; color: #666; margin-top: 6px;position:relative;left:0;top:0;" id="J_loadingTxt">刷新中</p></div>'
      );
      dom.before(pullGifDom);
      var isTop = false; // 是否为顶部
      var DISTANCE = 140; // 默认当滑动距离大于160, 触发刷新
      var isPullDown = false; // 是否下滑
      var startPostion = 0; // 记录滑动开始位置
      var distance = 0; // 记录滑动距离
      var timer = null; // 下拉加载节流
      var $loadingGif = $('#pullDowns'); // loading 动画
      var $loadingWarp = $('#pullDown'); // loading 动画容器
      var $text = $('#J_loadingTxt');
      var toUrlDistance = 220;
      var fn = {
        // 移动容器
      ...
      dom.bind('touchstart', function(e) {
        ...
        $text.html('下拉刷新');
        $loadingGif.removeClass('loadingGif');
      });
      // 滑动中
      dom.bind('touchmove', function(e) {
        var pageY = e.touches[0].pageY;
        distance = pageY - startPostion;
        var transY = distance / 3;
        var scaleSpeed = (distance / 200).toFixed(2); // gif 缩放速度
        scaleSpeed = scaleSpeed > 1.6 ? 1.6 : scaleSpeed;
        // 判断手势是上滑还是下滑
        if (isTop && distance > 0) {
          isPullDown = true;
        }
        if (isTop && isPullDown) {
          ...
          $loadingWarp.show();
          dom.css({
            '-webkit-transform': 'translate(0,' + transY + 'px)',
            transform: 'translate(0,' + transY + 'px)',
            '-webkit-transition': 'all 0s',
            transition: 'all 0s'
          });
          $loadingGif.css({
            '-webkit-transform': 'scale(' + scaleSpeed + ', ' + scaleSpeed + ')',
            transform: 'scale(' + scaleSpeed + ', ' + scaleSpeed + ')',
            '-webkit-transition': 'all 0.5s',
            transition: 'all 0.5s'
          });
          if (distance >= toUrlDistance && isHave && $('.pull-down-img').length) {
            $text.html('松开跳转');
          } else if (distance >= DISTANCE) {
            $text.html('松开刷新');
          } else if (distance >= 0) {
            if (isHave && showLogFlag && $('.pull-down-img').length) {
              showLogFlag = false;
              scope.app.appLinkShowLog({
                advUrl: advUrl,
                advId: advId
              });
            }
      ...
      dom.bind('touchend', function(e) {
        ...
        if (isTop && isPullDown) {
          if (distance >= toUrlDistance && isHave && $('.pull-down-img').length) {
            ...
            if (ua.indexOf('build/huawei') > -1) {
              // 华为手机使用不用的快应用js路径
              scriptUrl = '//appimg.dbankcdn.com/hwmarket/files/fastapp/router.fastapp.js';
            }
            GLOBAL.Util.getScript(scriptUrl, function() {
              // 官方回调：判断是否支持快应用  true:支持 false:不支持
              channelReady(function(status) { // eslint-disable-line
                // console.log('是否支持快应用::' + status);
                Cookies.set(nhjActOptions.cookieName, 1, {
                  expires: 1,
                  path: '/',
                  domain: 'eastday.com'
                });
                ...
                $('.pull-down-span').empty();
                e.preventDefault();
                var href = advUrl;
                scope.app.appLinkClickLog({
                  advId: advId,
                  advUrl: advUrl,
                  callback: function() {
                    if (status) {
                      appRouter('com.eastday.quickapp', '/', { // eslint-disable-line
                        url: href
                      });
                    } else {
                      window.location.href = href;
            ...
            setTimeout(function() {
              timer = setTimeout(function() {
                ...
                $loadingGif.addClass('loadingGif');
                $text.html('刷新中');
                setTimeout(function() {
                  // $('#pullDown').hide();
                  dom.css({
    ...
    pullDownLoadData: function(callback) {
      var scope = this;
      // 页码（获取之后减1再存储）24h
      scope.pulldown_pgNum = Number(wsCache.get('pulldown_pgnum_' + scope.newsType + '_' + GLOBAL.Et.qid));
      wsCache.set('pulldown_pgnum_' + scope.newsType + '_' + GLOBAL.Et.qid, --scope.pulldown_pgNum, {
        exp: 24 * 3600
      });
      // 下拉累计计数
      scope.pulldown_total_num = Number(wsCache.get('pulldown_total_num_' + scope.newsType + '_' + GLOBAL.Et.qid));
      ...
      wsCache.set('pulldown_total_num_' + scope.newsType + '_' + GLOBAL.Et.qid, ++scope.pulldown_total_num, {
        exp: 24 * 3600
      });
      // 获取链接索引
      scope.pulldown_idx = Number(wsCache.get('pulldown_idx_' + scope.newsType + '_' + GLOBAL.Et.qid));
    ...
    pullDownLoadDuanziData: function(callback) {
      ...
      $.ajax({
        ...
        data: {
          ...
          os: scope.osType,
          endkey: wsCache.get('startkey_' + scope.newsType + '_' + GLOBAL.Et.qid)
    ...
    pullDownLoadNewsData: function(callback) {
      ...
      var data = {
        htps: isHttps ? '1' : '0',
        type: scope.newsType,
        startkey: wsCache.get('startkey_' + scope.newsType + '_' + GLOBAL.Et.qid)
          ? wsCache.get('startkey_' + scope.newsType + '_' + GLOBAL.Et.qid)
          : scope.startKey[scope.newsType],
      ...
      $.ajax({
        ...
        error: function(e) {
          ...
          if (newsTimeoutQids[GLOBAL.Et.qid]) {
            scope.getNewsErrorForPulldown('pullDownLoadNewsData');
          }
        },
        complete: function() {
          callback && callback(); // jshint ignore:line
     ...
     * 请求新闻接口超时处理
     */
    getNewsErrorForPulldown: function() {
      var scope = this;
      wsCache.set('pulldown_pgnum_' + scope.newsType + '_' + GLOBAL.Et.qid, ++scope.pulldown_pgNum, {
        exp: 24 * 3600
      });
      ...
      var $rn = $('<div class="news-error-pulldown"><a class="recommend-news">数据异常，请稍后重试</a></div>');
      $rn.appendTo('body');
      setTimeout(function() {
        $rn.animate(
          {
    ...
    pullDownLoadAutoDataByOthers: function(callback) {
      ...
      $.ajax({
        ...
        data: {
          ...
          startkey: wsCache.get('startkey_' + scope.anewsType + '_' + GLOBAL.Et.qid)
    ...
    getVideoReadUrl: function() {
      ...
      if (scope.vnewsType === 'vtuijian') {
        ...
        ru = wsCache.get('video_read_url_' + scope.vnewsType + '_' + GLOBAL.Et.qid);
      }
      return ru || null;
    },
    ...
    getPicReadUrl: function() {
      ...
      if (scope.pnewsType === 'pbolan') {
        ...
        ru = wsCache.get('pic_read_url_' + scope.pnewsType + '_' + GLOBAL.Et.qid);
      }
      return ru || null;
    },
    ...
    pullDownComplete: function(len) {
      ...
      // 提示推荐新闻条数
      var $rn = $('<p id="J_recommend_news" class="recommend-news">为您推荐<span>' + len + '</span>条' + txt + '</p>');
      $rn.appendTo('body');
      setTimeout(function() {
        $rn.animate(
          {
      ...
      // 记录pulldown_idx
      wsCache.set('pulldown_idx_' + scope.newsType + '_' + GLOBAL.Et.qid, scope.pulldown_idx - len, {
        exp: 40 * 60
      });
      setTimeout(function() {
        // 清除pull-down类
    ...
    generateDomForPulldown: function(d) {
      ...
      wsCache.set('startkey_' + scope.newsType + '_' + GLOBAL.Et.qid, d.endkey, {
        exp: 24 * 3600
      });
      ...
      wsCache.set('tagskey_' + scope.newsType + '_' + GLOBAL.Et.qid, d.tagskey, {
        exp: 24 * 3600
      });
      ...
      for (var i = 0; i < len; i++) {
        var item = data[i],
          url = item.url,
          urlNum = url.substring(url.lastIndexOf('/') + 1, url.indexOf('.html')),
          dateStr = item.date,
          topic = item.topic,
          source = item.source,
        ...
        if (newNewsQids.contains(GLOBAL.Et.qid)) {
          scope.readUrlNum = JSON.parse(wsCache.get('read_urlnum_' + scope.newsType + '_' + GLOBAL.Et.qid)) || {};
    ...
    generateAutoDomForPulldownByOthers: function(d) {
      ...
      wsCache.set('startkey_' + scope.anewsType + '_' + GLOBAL.Et.qid, d.endkey, {
        exp: 24 * 3600
      });
    ...
    generateDomForDuanziPulldown: function(d) {
      ...
      wsCache.set('startkey_' + scope.newsType + '_' + GLOBAL.Et.qid, data[len - 1].endkey, {
        exp: 24 * 3600
      });
      // scope.endKey[scope.newsType] = d.newkey;
    ...
    updateDomLocation: function(loc) {
      ...
      $newsTabsWrap.children('a').each(function() {
        ...
        if ($this.attr('data-type') === type) {
          $this.after('<a data-type="' + loc.prov_py + '">' + loc.prov_name + '</a>');
          return false;
        }
      });
    },
    ...
    cacheVideoReadUrl: function(urlNum, type, subtype) {
      ...
      if (!scope.existVideoReadUrl(urlNum)) {
        ...
        wsCache.set('video_read_url_all_' + GLOBAL.Et.qid, scope.readUrl, {
          exp: 3 * 24 * 3600
        });
        // video_read_url_type
        ...
        if (subtype) {
          var rust = wsCache.get('video_read_url_' + subtype + '_' + GLOBAL.Et.qid); // xxxx,xxxx,xxxx
          if (rust) {
            rust = rust.split(',');
            while (rust.length >= 3) {
              rust.shift();
    ...
    cachePicReadUrl: function(urlNum, type, subtype) {
      ...
      if (!scope.existPicReadUrl(urlNum)) {
        ...
        if (subtype) {
          var rust = wsCache.get('pic_read_url_' + subtype + '_' + GLOBAL.Et.qid); // xxxx,xxxx,xxxx
          if (rust) {
            rust = rust.split(',');
            while (rust.length >= 3) {
              rust.shift();
    ...
    cacheAutoReadUrl: function(urlNum, type, subtype) {
      ...
      if (!scope.existAutoReadUrl(urlNum)) {
        ...
        if (subtype) {
          var rust = wsCache.get('auto_read_url_' + subtype + '_' + GLOBAL.Et.qid); // xxxx,xxxx,xxxx
          if (rust) {
            rust = rust.split(',');
            while (rust.length >= 3) {
              rust.shift();
    ...
    existVideoReadUrl: function(urlNum) {
      var video_read_url_all = wsCache.get('video_read_url_all_' + GLOBAL.Et.qid); // xxxx,xxxx,xxxx
      // 已经缓存过了
    ...
    addLog: function(options) {
      ...
      $.ajax({
        ...
        data: {
          ...
          from: options.fr || wsCache.get('prev_newstype_' + GLOBAL.Et.qid) || 'null', // url上追加的fr字段
          to: options.to || wsCache.get('current_newstype_' + GLOBAL.Et.qid) || 'null', // 当前页面
    ...
    refreshData: function(callback) {
      var scope = this;
      var cacheNews = wsCache.get('news_' + scope.newsType + '_' + GLOBAL.Et.qid),
        cachePos = wsCache.get('news_pos_' + scope.newsType + '_' + GLOBAL.Et.qid),
      ...
      if (cacheNews) {
        if (scope.newsType === 'wzry') {
          $newsList.before(wsCache.get('news_wzry_heros_' + GLOBAL.Et.qid) || '');
          scope.activeSwiper();
        }
        ...
        callback && callback(); // jshint ignore:line
        // 获取上拉加载了的缓存的百度ID
        cacheGgIdsForPullUp = wsCache.get('bdggid_pullup_' + scope.newsType + '_' + GLOBAL.Et.qid) || [];
        tempGgForPullUp = GLOBAL.Array.difference(GLOBAL.Et.ggForPullUp, cacheGgIdsForPullUp);
        // 获取上拉加载了的缓存的百度ID
        cacheGgIdsForDsp = wsCache.get('bdggid_dsp_' + scope.newsType + '_' + GLOBAL.Et.qid) || [];
        tempGgForDsp = GLOBAL.Array.difference(GLOBAL.Et.ggForDsp, cacheGgIdsForDsp);
        // 获取下拉加载了的缓存的百度ID
        cacheGgIdsForPullDown = wsCache.get('bdggid_pulldown_' + scope.newsType + '_' + GLOBAL.Et.qid) || [];
        tempGgForPullDown = GLOBAL.Array.difference(GLOBAL.Et.ggForPullDown, cacheGgIdsForPullDown);
        // 获取上拉加载了的缓存的文字链广告ID
        cacheTxtGgIdsForPullUp = wsCache.get('txtggid_pullup_' + scope.newsType + '_' + GLOBAL.Et.qid) || [];
        tempTxtGgForPullUp = GLOBAL.Array.difference(GLOBAL.Et.txtGgForPullUp, cacheTxtGgIdsForPullUp);
        // 获取下拉加载了的缓存的文字链广告ID
        cacheTxtGgIdsForPullDown = wsCache.get('txtggid_pulldown_' + scope.newsType + '_' + GLOBAL.Et.qid) || [];
        tempTxtGgForPullDown = GLOBAL.Array.difference(GLOBAL.Et.txtGgForPullDown, cacheTxtGgIdsForPullDown);
      } else {
        ...
        wsCache.delete('bdggid_pulldown_' + scope.newsType + '_' + GLOBAL.Et.qid);
        wsCache.delete('pulldown_idx_' + scope.newsType + '_' + GLOBAL.Et.qid);
        wsCache.delete('txtggid_pullup_' + scope.newsType + '_' + GLOBAL.Et.qid);
        wsCache.delete('txtggid_pulldown_' + scope.newsType + '_' + GLOBAL.Et.qid);
        ...
        scope.pgNum = 1;
        // 全量刷新计数
        scope.refresh_num = Number(wsCache.get('refresh_num_' + scope.newsType + '_' + GLOBAL.Et.qid));
        scope.pulldown_total_num = Number(wsCache.get('pulldown_total_num_' + scope.newsType + '_' + GLOBAL.Et.qid));
        var currTime = GLOBAL.Util.timeToString(new Date()).split(' ')[0];
        var cookieTime = wsCache.get('curr_date_list');
        if (currTime !== cookieTime) {
        ...
        wsCache.set('refresh_num_' + scope.newsType + '_' + GLOBAL.Et.qid, ++scope.refresh_num, {
          exp: 24 * 3600
        });
        wsCache.set('pulldown_total_num_' + scope.newsType + '_' + GLOBAL.Et.qid, ++scope.pulldown_total_num, {
          exp: 24 * 3600
    ...
    loadNewsData: function(callback) {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          // 页面滚到记录的位置处
          var cachePos = wsCache.get('news_pos_' + scope.newsType + '_' + GLOBAL.Et.qid);
          if (cachePos) {
            $(window).scrollTop(cachePos);
          }
        },
        error: function(e) {
          console.error('新闻请求超时:::\n', e);
          if (newsTimeoutQids[GLOBAL.Et.qid]) {
            scope.getNewsError('loadNewsData');
          }
        },
        complete: function() {
          callback && callback(); // jshint ignore:line
    ...
    generateDuanziDom: function(d) {
      ...
      for (var i = 0; i < len; i++) {
        ...
        // 非原生广告（原生广告url中不添加参数）
        url +=
          '?qid=' + GLOBAL.Et.qid + '&idx=' + (scope.idx + i + 1) + '&fr=' + scope.newsType + '&pgnum=' + scope.pgNum;
      ...
      // 记录idx
      wsCache.set('idx_' + scope.newsType + '_' + GLOBAL.Et.qid, scope.idx + len, {
        exp: 40 * 60
      });
      setTimeout(function() {
        // 缓存当前类别加载的新闻（缓存40分钟）
    ...
    loadVideoCtg: function() {
      ...
      if (!$videoCtgWrap) {
        ...
        $('#pullDown').css('top', '77px');
        $videoCtgWrap = $('<div class="news-video-ctg"></div>');
        for (var i = 0; i < videoCtg.length; i++) {
          var video = videoCtg[i];
      ...
      if (!$picCtgWrap) {
        ...
        for (var i = 0; i < picCtg.length; i++) {
          ...
          if (scope.pnewsType === pc.value) {
            $picCtgWrap.append(
              '<a class="J-pic-ctg active" data-type="' + pc.value + '" href="javascript:;">' + pc.name + '</a>'
            );
          } else {
            $picCtgWrap.append(
              '<a class="J-pic-ctg" data-type="' + pc.value + '" href="javascript:;">' + pc.name + '</a>'
            );
          }
        }
    ...
    loadAutoCtg: function() {
      ...
      if (!$autoNavWrap) {
        if (GLOBAL.Et.qid === 'null') {
          ...
          carUrl = 'https://mauto.mop.com/?qid=qid02624#lookAuto';
        }
        $autoNavWrap = $(
          '<div class="auto-nav">' +
    ...
    loadSportsList: function() {
      ...
      scope.getSportsListData(function(data) {
        ...
        var $sportSwiperWrapper = $('<div class="swiper-wrapper top-swiper"></div>');
        // var sportFlag = false;
        ...
        var swiper = new Swiper('.swiper-containers', { // eslint-disable-line
          slidesPerView: 5,
          spaceBetween: 0,
          pagination: {
    ...
    loadSportsMatch: function() {
      ...
      scope.getSportsMatchData(function(data) {
        ...
        var $swiperZhiBo = $('<div class="swiper-container swiper-zhibo" ></div>');
        // var sportFlag = false;
        // var sportsStatus = '';
        // var sportsScore = '';
        ...
        for (var i = 0; i < rst.length; i++) {
          ...
          if (ismatched === 1) {
            type = '集锦';
            score = sportsMatchData.home_score + ' : ' + sportsMatchData.visit_score;
            ...
            type = '未开始';
            score = GLOBAL.Util.getSpecialTimeStrForLive(sportsMatchData.starttime, curTime);
          } else {
        ...
        var $sportSwiperContainer = $(
          '<div class="swiper-wrapper" style="transform: translateX(' + transNum + 'px)"></div>'
        );
    ...
    loadWangzheHeros: function(data) {
      ...
      $swiperContainer.append($swiperWrapper).append('<div class="swiper-pagination"></div>');
      $wangzheContainer.append($swiperContainer).append($heroList);
      $newsList.before($wangzheContainer);
      scope.activeSwiper();
      wsCache.set('news_wzry_heros_' + GLOBAL.Et.qid, $wangzheContainer[0].outerHTML);
    },
    ...
    pullUpLoadData: function() {
      var scope = this;
      // 页码（获取之后加一再存储）
      scope.pgNum = Number(wsCache.get('pgnum_' + scope.newsType + '_' + GLOBAL.Et.qid));
      wsCache.set('pgnum_' + scope.newsType + '_' + GLOBAL.Et.qid, ++scope.pgNum, {
        exp: 24 * 3600
      });
      // 获取链接索引
      scope.idx = Number(wsCache.get('idx_' + scope.newsType + '_' + GLOBAL.Et.qid));
      if (!scope.idx) {
        scope.idx = 0;
      }
      if (scope.newsType === 'shipin') {
    ...
    pullUpLoadNewsData: function() {
      ...
      $.ajax({
        ...
        error: function(e) {
          console.error('新闻请求超时:::\n', e);
          if (newsTimeoutQids[GLOBAL.Et.qid]) {
            scope.getNewsErrorForPullUp('pullUpLoadNewsData');
          }
        },
        complete: function() {
          // scope.pullUpFlag = true;
    ...
    /*imgLazyload: function() {
      $('img[data-original]').lazyload({
        threshold: 100,
        placeholder: 'data:image/gif;base64,R0lGODlhAQABAJEAAAAAAP///////wAAACH5BAEAAAIALAAAAAABAAEAAAICVAEAOw=='
      });
    },*/
    //图片懒加载
    imgLazyload() {
      ...
      var init = function (obj) {
        ...
        for (i = 0; i < len; i++) {
          nodes[i].setAttribute('src', 'data:image/gif;base64,R0lGODlhAQABAJEAAAAAAP///////wAAACH5BAEAAAIALAAAAAABAAEAAAICVAEAOw==')
        }
    ...
    generateDom: function(d) {
      ...
      for (var i = 0; i < len; i++) {
        ...
        if (
          scope.pgNum === 1 &&
          goMopQid[GLOBAL.Et.qid] &&
          goMopQid[GLOBAL.Et.qid]['random'] > Math.random() &&
          goMopQid[GLOBAL.Et.qid]['position'].contains(i) &&
          newtypeArr.contains(scope.newsType) &&
          videonews != '2' && // 视频新闻
          ispicnews != '2' // 图集新闻
        ) {
          // 替换新闻地址 和qid
          url = url.replace('mini.eastday.com', 'mtoutiao.mop.com');
          toQid = 'qid10609';
        }
        url +=
          '?qid=' +
      ...
      for (var i = 0; i < len; i++) {
        ...
        $newsList.append(
          [
            ...
            aStr + '<div class="info">',
            '<h3 class="title dotdot line3">' + topic + '</h3>',
            '<p class="tags"><em class="tag tag-time">' + (tagStr || dateStr || '') + '</em>',
            commentCountStr,
            urlpvStr,
            '<em class="tag tag-src">' + source + '</em>',
            '</p>',
    ...
    prependGgDom: function(i) {
      ...
      if ($.inArray(i, ggPulldownPos) !== -1) {
        ...
        $newsList.prepend('<div id="' + ggWrapId + '" class="J-gg-item"></div>');
      }
    },
    ...
    appendGgDom: function(i, len) {
      ...
      if (GLOBAL.Et.qid === 'wfky') {
        ...
        if ($.inArray(i, ggPullupPos) !== -1) {
          ...
          $newsList.append('<div id="' + ggWrapId2 + '" class="J-gg-item"></div>');
        } else {
          ggWrapId2 =
            'ggwrap2_' +
            Math.random()
      ...
      // li 位置下新增广告
      // $.inArray(i, ggPosition) !== -1;
      if (GLOBAL.Et.addGgUnderLi[GLOBAL.Et.qid] && scope.pgNum === 1) {
        var pbGgPosition = GLOBAL.Et.addGgUnderLi[GLOBAL.Et.qid]['area'] || [];
        if (
          $.inArray(i, GLOBAL.Et.addGgUnderLi[GLOBAL.Et.qid]['ggPosition']) !== -1 &&
          !scope.filterArea(pbGgPosition)
        ) {
          var type = GLOBAL.Et.addGgUnderLi[GLOBAL.Et.qid]['type'];
          var id = GLOBAL.Et.addGgUnderLi[GLOBAL.Et.qid][i];
          scope.loadUnionGg({ type: type, id: id, $dom: $newsList });
        }
      }
    },
    ...
    loadGg: function() {
      ...
      scope.getDsp(function(dspData) {
        ...
        if (GLOBAL.Et.qid === 'qid10843' && scope.filterArea(['北京', '上海', '广州', '深圳'])) {
          unionGg = [];
        }
    ...
    loadBaiduGg: function(gg) {
      ...
      var $dom = gg.$dom;
      if (isV5) {
        $dom.append('<div class="bdgg-wrap"><div id="' + ggId + '"></div><div class="line"></div></div>');
        GLOBAL.Util.getScript('//sh996.dftoutiao.com/' + ggId + '.js', function() {}, $('#' + ggId)[0]);
      } else {
        ggConfig =
        ...
        $dom.append('<div class="bdgg-wrap"><div id="cpro_' + ggId + '"></div><div class="line"></div></div>');
        GLOBAL.Util.createScript(
          ggConfig,
          function() {
            GLOBAL.Util.getScript('//cpro.baidustatic.com/cpro/ui/cm.js', function() {}, $('#cpro_' + ggId)[0]);
          },
          $('#cpro_' + ggId)[0]
        );
      }
    ...
    loadBaiduGg2: function(gg) {
      var str = gg.id;
      var scriptSrc = str.substring(str.indexOf('src="') + 5, str.lastIndexOf('">'));
      scriptSrc = scriptSrc.replace('//df666.pzhttaax.cn', '//sh996.dftoutiao.com');
      var id = Math.random()
      .toString(36)
      .split('.')[1];
      gg.$dom.append('<div class="bdgg-wrap"><div id="' + id + '"></div><div class="line"></div></div>');
    ...
    loadSspGg: function(gg) {
      ...
      if (height && height.indexOf(':') > -1) {
        height = (window.screen.width / height.split(':')[0]) * height.split(':')[1];
      }
      gg.$dom.append(
    ...
    loadYnGg: function(gg) {
      var ggId = gg.id;
      gg.$dom.append('<div id="' + ggId + '" class="bdgg-wrap"></div><div class="line"></div>');
      GLOBAL.Util.getScript('//js.soarfi.cn/' + ggId + '.js', function() {}, $('#' + ggId)[0]);
    },
    ...
    cacheTxtGgIdForPullUp: function(id) {
      var scope = this,
        arr = wsCache.get('txtggid_pullup_' + scope.newsType + '_' + GLOBAL.Et.qid) || [];
      if (!arr.contains(id)) {
        arr.push(id);
      }
      wsCache.set('txtggid_pullup_' + scope.newsType + '_' + GLOBAL.Et.qid, arr, {
        exp: 40 * 60
      });
    },
    ...
    cacheTxtGgIdForPullDown: function(id) {
      var scope = this,
        arr = wsCache.get('txtggid_pulldown_' + scope.newsType + '_' + GLOBAL.Et.qid) || [];
      if (!arr.contains(id)) {
        arr.push(id);
      }
      wsCache.set('txtggid_pulldown_' + scope.newsType + '_' + GLOBAL.Et.qid, arr, {
        exp: 40 * 60
      });
    },
    ...
    cacheBdGgIdForPullUp: function(id) {
      var scope = this,
        arr = wsCache.get('bdggid_pullup_' + scope.newsType + '_' + GLOBAL.Et.qid) || [];
      if (!arr.contains(id)) {
        arr.push(id);
      }
      wsCache.set('bdggid_pullup_' + scope.newsType + '_' + GLOBAL.Et.qid, arr, {
        exp: 40 * 60
      });
    },
    ...
    cacheBdGgIdForDsp: function(id) {
      var scope = this,
        arr = wsCache.get('bdggid_dsp_' + scope.newsType + '_' + GLOBAL.Et.qid) || [];
      if (!arr.contains(id)) {
        arr.push(id);
      }
    ...
    cacheBdGgIdForPullDown: function(id) {
      var scope = this,
        arr = wsCache.get('bdggid_pulldown_' + scope.newsType + '_' + GLOBAL.Et.qid) || [];
      if (!arr.contains(id)) {
        arr.push(id);
      }
      wsCache.set('bdggid_pulldown_' + scope.newsType + '_' + GLOBAL.Et.qid, arr, {
        exp: 40 * 60
      });
    },
    ...
    loadDsp: function(d, $dom) {
      ...
      var deliveryid = d.deliveryid;
      var url = d.url;
      var dateStr = scope.getSpecialTime(d.date) || '';
      var topic = d.topic;
      ...
      if (sectors) {
        if ((dspIndex - 1) % 2 !== 0) {
          var cacheSectors = wsCache.get('dsp_read_sectors') ? wsCache.get('dsp_read_sectors').split(',') : [];
      ...
      var videoBtn = '';
      if (scope.newsType === 'shipin' && !scope.filterArea(['北京', '上海', '广州', '深圳', '成都', '杭州'])) {
        videoBtn = '<span class="video-btn"></span>';
      }
      if (reporturl) {
      ...
      if (adStyle === 'big' || bigpic === 1) {
        ...
        dataStr =
          ...
          topic +
          '</h3>' +
          '<div class="img-wrap clearfix" style="position:relative;">' +
          videoBtn +
          '<img class="lazy fl image-error" src="' +
          (imgArr.length ? scope.replaceImg(imgArr[0].src) : '') +
          '"></div>' +
        ...
        if (subadStyle === '1') {
          dataStr =
            ...
            '<div class="news-left fl"><img class="image-error" src="' +
            (imgArr.length ? scope.replaceImg(imgArr[0].src) : '') +
            '"></div>' +
            '<div class="news-right fr"><img class="image-error" src="' +
            (imgArr.length ? scope.replaceImg(imgArr[1].src) : '') +
            '">' +
            '<img class="img-two image-error" src="' +
            (imgArr.length ? scope.replaceImg(imgArr[2].src) : '') +
            '"></div>' +
            '</div>' +
            '<div class="dsp-tag">' +
          ...
          dataStr =
            ...
            '</h3>' +
            '<div class="img-wrap clearfix">' +
            '<div class="img fl"><img class="lazy image-error" src="' +
            (imgArr.length ? scope.replaceImg(imgArr[0].src) : '') +
            '"></div>' +
            '<div class="img fl"><img class="lazy image-error" src="' +
            (imgArr.length ? scope.replaceImg(imgArr[1].src) : '') +
        ...
        dataStr =
          ...
          // '<div class="new-tag"></div>' +
          '</div>' +
          '<div class="img-wrap fr" style="position:relative;">' +
          videoBtn +
          '<img class="lazy image-error" src="' +
          (imgArr.length ? scope.replaceImg(imgArr[0].src) : '') +
          '"></div>' +
          '</div>' +
          '</a>' +
    ...
    /**
     * 图片加载失败上报
     * 测试地址：http://106.75.98.65/dspdatalog/imgerr
     */
    imgError: function(options) {
      $.ajax({
        url: 'https://reportlog.dftoutiao.com/dspdatalog/imgerr',
        dataType: 'jsonp',
        jsonp: 'jsonpcallback',
        data: {
          hisid: options.deliveryid || 'null',
          imgpath: options.url,
          site: GLOBAL.Util.getQueryString('apptypeid') || 'DFTT',
          qid: GLOBAL.Et.qid
        },
        success: function() {}
      });
    ...
    sendAllianceLog: function(options) {
      ...
      var userInfo = JSON.parse(wsCache.get('union_' + GLOBAL.Et.uid + '_info'));
      $.ajax({
        url: logUrl,
        data: {
  ...
  App.prototype = {
    ...
    getDspGg: function(options, callback) {
      ...
      $.ajax({
        ...
        data: {
          ...
          readnewstype: (GLOBAL.Et.readNewsTypeArr && GLOBAL.Et.readNewsTypeArr.join(',')) || '',
    ...
    loadBottomDownload: function() {
      ...
      $body.on('click', '.J-bottomappdownload', function(e) {
        ...
        if (GLOBAL.Os.android) {
          var timer = setTimeout(function() {
            window.location.href = 'https://down.hao1982.com/android/qdb/h5/dongfangtoutiao_h5bannerheng.apk';
          }, 3000);
    ...
    getWechatAppUrl: function() {
      var wechatUrl = 'https://a.app.qq.com/o/simple.jsp?pkgname=com.songheng.eastnews&ckey=CK1354046807133';
      return wechatUrl;
    },
    ...
    getAndroidAppUrl: function() {
      ...
      scope.wakeUpUrlMarket = 'market://details?id=com.songheng.eastnews&back=true&ref=other';
      scope.wakeUpUrl =
        typeUrl +
        '?url=' +
        frurl +
        ...
        '&ttype=' +
        (ttype || 'detail'); // 唤醒链接
      scope.wechatUrl = 'https://a.app.qq.com/o/simple.jsp?pkgname=com.songheng.eastnews&ckey=' + ckey;
      scope.androidUrl = 'https://down.hao1982.com/android/qdb/h5/dongfangtoutiao_h5bannerheng.apk';
      // pkgname = 'wakeuppkgname';
      var phoneType = window.navigator.userAgent.toLowerCase();
      if (phoneType.indexOf('gionee') === -1 && phoneType.indexOf('sm-a9100') === -1) {
